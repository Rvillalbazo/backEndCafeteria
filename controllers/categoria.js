...
exports.getCategoria = async (req, res) => {
    try {
        ...
        const records = await Categoria.find(query);
...
exports.getCategoriaByID = async (req, res) => {
    try {
        ...
        const record = await Categoria.findById(id);
...
exports.createCategoria = async (req, res) => {
    try {        
        const record = new Categoria({ ...req.body });
        await record.save();
...
exports.updateCategoria = async (req, res) => {
    try {
        ...
        const updatedRecord = await Categoria.findByIdAndUpdate(id, data, { new: true }); 
